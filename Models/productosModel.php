...
Programa:          Módulo Productos
Fecha:             01-Marzo-2022
Programador:       Kevin Alfredo Rodríguez Zúniga
descripción:       Maneja los productos de la tienda 
    ...
    class ProductosModel extends Mysql{
        ...
        public function selectProductos(){
			...
			public function insertProducto(string $nombre, string $descripcion, int $codigo, int $categoriaid, string $precio, int $stock,string $ruta, int $status, int $user){
				...
				*/
				$sql= "CALL CRUD_PRODUCTOS(null,'{$this->intCodigo}','{$this->strNombre}',null,null,null,null,null,null,null,null,'A',null)";
				/* dep($sql);
				exit; */
				$request = $this->select_all($sql);
				if(empty($request))
		...
		public function updateProducto(int $idproducto, string $nombre, string $descripcion, int $codigo, int $categoriaid, string $precio, int $stock, string $ruta, int $status, int $user){
			 ...
			 */
			$sql= "CALL CRUD_PRODUCTOS(null,'{$this->intCodigo}','{$this->strNombre}',null,null,null,null,null,null,null,NULL,'B',$this->intIdProducto)";
		...
		/* 	$sql = "SELECT p.idproducto,
					...
					ON p.categoriaid = c.idcategoria
					WHERE idproducto = $this->intIdProducto"; */
					$sql ="call CRUD_PRODUCTOS(null,null,null,null,null,null,null,null,null,null,NULL,'R',{$this->intIdProducto})";
		...
		public function deleteProducto(int $idproducto){
			...
			$arrData = array(0); */
			$sql ="call CRUD_PRODUCTOS(null,null,null,null,null,null,null,null,null,null,NULL,?,{$this->intIdProducto})";
			$arrData = array('D');
