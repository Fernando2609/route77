...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2022 a las 08:14:06
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `CRUD_CATEGORIA` (IN `PI_COD_STATUS` INT(11), IN `PV_DESCRIPCION` VARCHAR(100), IN `PV_NOMBRE` VARCHAR(50), IN `PV_PORTADA` VARCHAR(200), IN `PI_CREADO_POR` BIGINT(20), IN `PI_MODIFICADO_POR` BIGINT(20), IN `PV_RUTA` VARCHAR(255), IN `MODO` CHAR(1), IN `COD` BIGINT(20))  BEGIN
START TRANSACTION;
...
INSERT INTO `post` (`COD_POST`, `TITULO`, `CONTENIDO`, `PORTADA`, `RUTA`, `COD_STATUS`, `FECHA_CREACION`) VALUES
(1, 'Nosotros', '<h1>Contenido de la pagina Nosotros</h1>', NULL, 'nosotros', 1, '2022-04-23 16:31:16');
...
(6, 1, 'Reunión con inversionistas', 'Reunión con inversionistas', '2022-04-04 10:00:00', '2022-04-04 13:00:00', '#dd2cd7', '#000000', '2022-04-09 16:23:59', '2022-04-19 16:42:32'),
...
(8, 1, 'Cumpleaños', 'Cumpleaños del Trabajador de route 77 Víctor García', '2022-05-21 00:00:00', '2022-05-21 23:59:00', '#007bff', '#ffffff', '2022-04-19 22:57:22', '0000-00-00 00:00:00');
...
(8, 1, 'Cortes de Carne Exquisitos', 'Carnes', 'img_bae3f79bb7cb93684e0630b8583f0758.jpg', 'carnes', 1, '2022-04-19 01:55:20', 1, '2022-04-24 11:07:20');
...
(19, 'Contactos', 'Mensajes de el formulario contacto', 1),
(20, 'Páginas', 'Páginas del sitio Web', 1);
...
(31, 1, '2022-04-19 16:41:57', '2000.00', '300.00', 1, 5012121);
...
(72, 62, '2022-04-21 19:01:56', '7.00', '0.00', 2, 'Flor del campo Zona 2, 11101', 1, NULL, NULL, NULL, 0, '2022-04-21 19:01:56', 0, '0000-00-00 00:00:00');
...
(1, 'José Fernando', 'Ortiz Santos', 'josefortizsantos@gmail.com', '65d452d53579e16d2fdf9228577b6eac314b59163f1c6ad43b61032109d3f608', 1, 1, 98912132, '4c83eddc81167c2e315d-e798df55058e526f3b6f-5c0529e2da4bcfe8e900-4986e7ec685cd4ee2174', 51, '2022-02-12 02:22:51', 1, '2022-04-20 10:29:08', '2022-04-25 21:44:05'),
...
(49, 'Kevin Alfredo', 'Rodriguez', 'karodriguezz@unah.hn', 'dd75ba64297196aa490cf83772f5373aa4e6ee78544374604d95ac5117d3beda', 8, 1, 32301533, '', 1, '2022-03-24 17:37:43', 1, '2022-04-25 16:53:48', '2022-04-25 21:49:03'),
...
(53, 'HUGO', 'PIZA', 'ffernandada@gmail.com', '', 3, 1, 123123123, '', 1, '2022-04-04 02:10:56', 1, '2022-04-19 16:41:12', '0000-00-00 00:00:00'),
(62, 'Pedro Enrique', 'Bustillo', 'josefortizsantos2000@gmail.com', '4323acccb4773f72760897f8a9c394e829681e3e60b229e2d9cb21b01ed2f6ce', 2, 1, 94877564, '', NULL, '2022-04-18 14:06:02', 1, '2022-04-19 15:22:32', '2022-04-21 19:00:35');
...
(18, 3, '234235235', 'Labial', '<p>Labial rojo&nbsp;</p>', '2500.00', 'labial', 1, '2022-04-19 10:27:13', 1, '2022-04-20 02:29:59', 1);
...
(5, 53, 'La Colonia', 123123, 'La Pradera');
...
(10, 70, '1YH62000AE9885135', '{\"id\":\"1YH62000AE9885135\",\"status\":\"COMPLETED\",\"links\":[{\"href\":\"https:\\/\\/api.sandbox.paypal.com\\/v2\\/payments\\/refunds\\/1YH62000AE9885135\",\"rel\":\"self\",\"method\":\"GET\"},{\"href\":\"https:\\/\\/api.sandbox.paypal.com\\/v2\\/payments\\/captures\\/13Y94839UA610281D\",\"rel\":\"up\",\"method\":\"GET\"}]}', 'ya no lo necesita', 'COMPLETED');
...
--
ALTER TABLE `post`
  MODIFY `COD_POST` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tbl_calendario`
--
ALTER TABLE `tbl_calendario`
  MODIFY `COD_CALENDARIO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `TBL_CONTACTO`
  MODIFY `COD_CONTACTO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tbl_detalle_compra`
--
ALTER TABLE `tbl_detalle_compra`
  MODIFY `COD_DETALLE` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL DETALLE DE COMPRA', AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `tbl_detalle_pedido`
--
ALTER TABLE `tbl_detalle_pedido`
  MODIFY `COD_DETALLE` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL DETALLE PEDIDO', AUTO_INCREMENT=76;
...
--
ALTER TABLE `tbl_modulo`
  MODIFY `COD_MODULO` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL MÓDULO', AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `tbl_orden_compra`
--
ALTER TABLE `tbl_orden_compra`
  MODIFY `COD_ORDEN` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE LA ORDEN DE COMPRA', AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `tbl_pedido`
--
ALTER TABLE `tbl_pedido`
  MODIFY `COD_PEDIDO` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL PEDIDO', AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT de la tabla `tbl_permisos`
--
ALTER TABLE `tbl_permisos`
  MODIFY `COD_PERMISO` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE PERMISO', AUTO_INCREMENT=1214;
...
--
ALTER TABLE `tbl_reembolso`
  MODIFY `COD_REEMBOLSO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
