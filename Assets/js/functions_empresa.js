     ...
     request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#celRazonSocial").innerHTML = objData.data.RAZON_SOCIAL;
                document.querySelector("#celEmail").innerHTML = objData.data.EMAIL;
                document.querySelector("#celGerenteGeneral").innerHTML = objData.data.GERENTE_GENERAL;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtNombreEmpresa").value = objData.data.NOMBRE_EMPRESA;
                document.querySelector("#txtDireccion").value = objData.data.DIRECCION;
                document.querySelector("#txtRazonSocial").value = objData.data.RAZON_SOCIAL;
                document.querySelector("#txtEmail").value = objData.data.EMAIL;
                document.querySelector("#txtGerenteGeneral").value = objData.data.GERENTE_GENERAL;
