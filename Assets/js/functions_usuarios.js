...
//Funcion para traer Las preguntaas
function fnPreguntasUsuario() {
  let ajaxUrl = base_url + "/Usuarios/getSelectPreguntas";
  let request = window.XMLHttpRequest
    ? new XMLHttpRequest()
    : new ActiveXObject("Microsoft.XMLHTTP");
  request.open("GET", ajaxUrl, true);
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4 && request.status == 200) {
      console.log(request.responseText);
      document.querySelector("#listPreguntas").innerHTML = request.responseText;
      document.querySelector("#listPreguntas").value = pregunta;
      $("#listPreguntas").selectpicker("render");
    }
  };
}
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (objData.status) {
        ...
        document.querySelector("#celSucursal").innerHTML =
          objData.data.SUCURSAL;
        ...
        document.querySelector("#celModPor").innerHTML =
          objData.data.MODIFICADO_POR;
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (objData.status) {
        ...
        document.querySelector("#listSucursal").value =
          objData.data.COD_SUCURSAL;
