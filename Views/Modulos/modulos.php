        ...
        <div class="container-fluid"><!-- Div Container-Fluid -->
          <div class="row mb-2"> <!-- Div row y margen abajo de 2-->
            <div class="col-sm-6 d-flex"><!-- Div 6 columnas derecha-->
              <!--Titulo-->
              <h1><i class="fa-solid fa-cubes"></i> <?= $data['page_title'] ?> </h1>
              <!--Boton Nuevo-->
            ...
            <div class="col-sm-6"> <!-- Div 6 columnas Izquierda-->
              <ol class="breadcrumb float-sm-right">
                <!--Icono Casa-->
              <li class="breadcrumb-item"><a href="<?=base_url();?>/modulos"><i class="fas fa-home casa"></i></a></li>
            ...
            <div class="col-12"><!-- div 12 -->
              <div class="card"><!-- div card -->
                ...
                <div class="card-header">
                  <h2 class="card-title">Tabla de Modulos</h2>
                </div>
                <!-- /.card-body -->
                <div class="card-body">
                  <!-- Tabla -->
                  <table id="tableModulos" class="table table-hover table-bordered  dataTable dtr-inline collapsed" role="grid">
