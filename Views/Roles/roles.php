            ...
            <div class="col-12"><!-- div 12 -->
              <div class="card"><!-- div card -->
                ...
                <div class="card-header">
                  <h2 class="card-title">Tabla de Roles</h2>
                </div>
                <!-- /.card-body -->
                <div class="card-body">
                  <!-- Tabla -->
                  <table id="tableRoles" class="table table-hover table-bordered table-striped dataTable dtr-inline collapsed" role="grid">
