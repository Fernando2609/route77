            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        <!--Icono Casa-->
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>/telEmpresa"><i class="fas fa-home casa"></i></a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Tabla -->
                            <table id="tabletelEmpresa" class="table table-hover table-bordered  dataTable dtr-inline collapsed" role="grid">
