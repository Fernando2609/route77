<?php
headerAdmin($data);
getModal('modalredesSociales', $data);
?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        <!--Icono Casa-->
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>/redesSociales"><i class="fas fa-home casa"></i></a></li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h2 class="card-title">Tabla de Redes Sociales</h2>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-body">
                            <!-- Tabla -->
                            <table id="tableredesSociales" class="table table-hover table-bordered  dataTable dtr-inline collapsed" role="grid">
