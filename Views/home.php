					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							if ($arrProductos[$p]['stock']>0) {?>
								...
								Ver producto
							<?php }else{ ?>
								<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['idproducto'].'/'.$rutaProducto;?>" class="block2-btn flex-c-m stext-103 cl2 size-103  bg0 bor2 hov-btn1 p-lr-15 trans-04 pAgotado">
								Producto Agotado	
							<?php } ?>
							</a>
						</div>
