...
<body style="background-color: #f3de2e; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f3de2e;">
        <tbody>
            <tr>
                <td>
                                                    ...
                                                    <table class="image_block" width="100%" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><a href="<?=  base_url()  ?>" target="_blank" style="outline:none" tabindex="-1"><img
                                                                        class="big"
                                                                        src="<?= media(); ?>/images/email/animated_header.png"
                    ...
                    <table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa; background-image: url('<?= media(); ?>/images/email/body_background_3.png'); background-position: top center; background-repeat: repeat;">
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #055488; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                        <p
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p style="margin: 0; text-align: center;">
                                                                            Hola&nbsp;<strong><?= $data['nombreUsuario']; ?></strong></p>
                                                                        <p
                                                                            style="margin: 0; text-align: center; mso-line-height-alt: 16.8px;">
                                                                            &nbsp;</p>
                                                                        <p style="margin: 0; text-align: center;">Has
                                                                            solicitado el cambio de contraseña de tu
                                                                            usuario:</p>
                                                                        <p style="margin: 0; text-align: center;">
                                                                            <strong><a
                                                                                    href="mailto:josefortizsantos@gmail.com"
                                                                                    rel="noopener" target="_blank"
                                                                                    style="color: #40507a;"><?= $data['email']; ?></a></strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                        <p style="margin: 0; text-align: center;">
                                                                            Accede&nbsp;al botón de abajo para
                                                                            confirmar tu nueva contraseña.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="button_block" width="100%" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?= $data['url_recovery']; ?>" style="height:48px;width:209px;v-text-anchor:middle;" arcsize="34%" stroke="false" fillcolor="#81b031"><w:anchorlock/><v:textbox inset="5px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:15px"><![endif]--><a
                                                                        href="<?= $data['url_recovery']; ?>" target="_blank"
                                                                        style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#81b031;border-radius:16px;width:auto;border-top:0px solid TRANSPARENT;font-weight:400;border-right:0px solid TRANSPARENT;border-bottom:0px solid TRANSPARENT;border-left:0px solid TRANSPARENT;padding-top:8px;padding-bottom:8px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                                            style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:1px;"><span
                                                                                style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                                    ...
                                                                                    data-mce-style="font-size: 15px; line-height: 30px;"><strong>Cambiar
                                                                                        Contraseña</strong></span></span></span></a>
                                                    ...
                                                    <table class="text_block" width="100%" border="0" cellpadding="10"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 21px; color: #40507a; line-height: 1.5; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            Si no te funciona el botón puedes copiar y
                                                                            pegar la siguiente dirección en tu
                                                                            navegador:</p>
                                                                        <p
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <a href="<?= $data['url_recovery']; ?>" target="_blank"
                                                                                style="text-decoration: underline; color: #40507a;"
                                                                                rel="noopener"><?= $data['url_recovery']; ?></a></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p style="margin: 0; font-size: 14px;"><span
                                                                                style="font-size:14px;">¿Tienes
                                                                                Problemas? Escríbenos: <a
                                                                                    href="mailto:<?=datosEmpresa()['Empresa']['EMAIL_EMPRESA']?>"
                                                                                    target="_blank"
                                                                                    title="Correo"
                                                                                    style="text-decoration: none; color: #40507a;"
                                                                                    rel="noopener"
                                                                                    bis_size="{&quot;x&quot;:396,&quot;y&quot;:360,&quot;w&quot;:107,&quot;h&quot;:16,&quot;abs_x&quot;:396,&quot;abs_y&quot;:420}"><strong><?=  datosEmpresa()['Empresa']['EMAIL_EMPRESA']  ?></strong></a></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                        <p style="margin: 0;">Si no has solicitado el
                                                                            cambio de contraseña ignora este correo.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        class="big"
                                                                        src="<?= media(); ?>/images/email/bottom_img.png"
                                                                        style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;"
                                                                        width="600"
                                                            ...
                                                            <td>
                                                                <div align="center" style="line-height:10px"><a
                                                                        ...
                                                                        style="outline:none" tabindex="-1"><img
                                                                            ...
                                                                            src="<?= media(); ?>/tienda/images/icons/logoTienda.png"
                                                                            style="display: block; height: auto; border: 0; width: 232px; max-width: 100%;"
                                                                            width="232" alt="Your Logo"
                                                                            title="Your Logo"></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table class="social_block" width="100%" border="0" cellpadding="10"
                                                        cellspacing="0" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                        <tr>
                                                            <td>
                                                                <table class="social-table" width="210px" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:0 5px 0 5px;"><a
                                                                                href="<?= base_url()  ?>"
                                                                                target="_blank"><img
                                                                                    src="<?= media(); ?>/images/email/website2x.png"
                                                                                    width="32" height="32"
                                                                                    alt="Web Site" title="Web Site"
                                                                                    style="display: block; height: auto; border: 0;"></a>
                                                                        </td>
                                                                        <td style="padding:0 5px 0 5px;"><a
                                                                                href="https://www.facebook.com/estacion77/"
                                                                                target="_blank"><img
                                                                                    src="<?= media(); ?>/images/email/facebook2x.png"
                                                                                    width="32" height="32"
                                                                                    alt="Facebook" title="Facebook"
                                                                                    style="display: block; height: auto; border: 0;"></a>
                                                                        </td>
                                                                        <td style="padding:0 5px 0 5px;"><a
                                                                                href="https://www.instagram.com/estacion_77/"
                                                                                target="_blank"><img
                                                                                    src="<?= media(); ?>/images/email/instagram2x.png"
                                                                                    width="32" height="32"
                                                                                    alt="Instagram" title="instagram"
                                                                                    style="display: block; height: auto; border: 0;"></a>
                                                                        </td>
                                                                        <td style="padding:0 5px 0 5px;"><a
                                                                                href="https://api.whatsapp.com/send?phone=50494877564&amp;text=Hola!&nbsp;me&nbsp;pueden&nbsp;apoyar?"
                                                                                target="_blank"><img
                                                                                    src="<?= media(); ?>/images/email/whatsapp2x.png"
                                                                                    width="32" height="32"
                                                                        ...
                                                                        <td style="padding:0 5px 0 5px;"><a
                                                                                href="mailto:<?=  datosEmpresa()['Empresa']['EMAIL_EMPRESA']  ?>"
                                                                                target="_blank"><img
                                                                                    src="<?= media(); ?>/images/email/mail2x.png"
                                                                                    width="32" height="32" alt="E-Mail"
                                                                                    title="E-Mail"
                                                                                    style="display: block; height: auto; border: 0;"></a>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            <?=  datosEmpresa()['Empresa']['CEL_EMPRESA']  ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Copyright© 2022 Estación Route 77.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
