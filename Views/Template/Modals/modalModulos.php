<!-- Modal -->
<div class="modal fade" id="modalFormModulo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" >
  <!-- Div Centrar Modal -->
  <div class="modal-dialog modal-dialog-centered bounceInDown animated" role="document">
    <div class="modal-content" ><!-- Div Contenido Modal -->
      <div class="modal-header headerRegister "> <!-- Encabezado Modal -->
        <h5 class="modal-title" id="titleModal">Registro De Nuevo Módulo</h5>
              ...
              <input type="hidden" id="idModulo" name="idModulo" value="">
                <div class="card-body"><!-- Card Body-->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control valid validText" id="txtNombreModulo" name="txtNombreModulo" placeholder="Nombre del Módulo" required="">
                  </div>
                  <!-- Cierra Text -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtDescripcionModulo" name="txtDescripcionModulo" placeholder="Descripción del Módulo" required="">
                  </div>
                  <!-- Cierra Div Text -->
                  <!-- Div Form-Group -->
                  <div class="form-group">
